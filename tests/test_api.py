...
import io
from src.quick_draw.backend_api import app  # Import our fastapi app
...
def test_predict_endpoint_valid_image(mock_image):
...
def test_categories_list():
    ...
    from src.quick_draw.backend_api import CATEGORIES
